...
You can download mysql image from repository https://hub.docker.com/repository/docker/yurakhilko/mysql-local/general. Dowload image with 1.0.0 tag.
...
You can download todoapp image from repository https://hub.docker.com/repository/docker/yurakhilko/todoapp/general. Dowload image with 2.0.0 tag.
